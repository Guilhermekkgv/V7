...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Button(config)
            ...
            local clickColor = Color3.fromRGB(50, 50, 50)
            local originalColor = Color3.fromRGB(0, 0, 0)
        ...
        function TabElements.Toggle(config)
            ...
            local function UpdateToggle()
                ...
                if State then
                    TweenService:Create(ToggleBox, tween, {BackgroundColor3 = Color3.fromRGB(50, 50, 50)}):Play()
                    TweenService:Create(CheckIcon, tween, {ImageTransparency = 0}):Play()
                else
                    TweenService:Create(ToggleBox, tween, {BackgroundColor3 = Color3.fromRGB(0, 0, 0)}):Play()
                    TweenService:Create(CheckIcon, tween, {ImageTransparency = 1}):Play()
                end
                task.wait(0.2)
                isToggling = false
            end
